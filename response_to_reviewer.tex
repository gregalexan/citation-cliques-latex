...
Citation-Network Cohesion and Reciprocal Citation Cliques Across Journal-Impact Strata:\\
...
\location{Anomaly Screen and anomaly results; pp.~14--16, 19--20, and 31; Tables~\ref{ms-tab:anomaly-enrichment}, \ref{ms-tab:anomaly-overlap}, \ref{ms-tab:anomaly-sensitivity}, and~\ref{ms-tab:anomaly-feature-ablation}}{218--279 and 304--312}
...
For the author analysis, the Methods formally defines the loopless directed weighted graph $G_s$ and its binary undirected projection $U_s$.  It identifies the population, direction, weight, denominator, and missingness rule for every measure.  Direction is discarded only for $U_s$ clustering and clique membership; reciprocity, balance, tier mixing, and the clique density measure retain direction and fractional weights.  The label-swap $p$-value tests the within-tier fractional-weight share, while weighted assortativity is reported separately as a descriptive statistic.  The new clique tables provide the analytical basis for the network characterization.

\location{Data and Cohort, Network Construction, Anomaly Screen, and network results; pp.~4--5, 7--12, 15--16, and 20--23; Tables~\ref{ms-tab:metric-definitions}, \ref{ms-tab:tier-mixing}, \ref{ms-tab:clique-summary}, and \ref{ms-tab:clique-sensitivity}}{83--104, 145--214, 261--279, and 314--345}
