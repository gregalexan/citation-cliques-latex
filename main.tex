...
The regenerated evidence is summarized as follows.  \PrimaryFindingText\ \AnomalyFindingText\ \MixingFindingText\ The detailed estimates, intervals, and sensitivity results in Section~\ref{sec:results} govern interpretation when a short summary masks heterogeneous directions or uncertainty.
